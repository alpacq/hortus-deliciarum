...
const TitledParagraph = ({ isMobile, isCarousel, isFinal, title, text, isGreen, hasButton, hasMobileButton, isMobileButtonUp, isButtonBig, buttonText="", mobileButtonText="", linkUrl="/", isButtonRight, imageUrl="", imageAlt="" }) => {
  const richText = {
    __html: text
  }
  return (
